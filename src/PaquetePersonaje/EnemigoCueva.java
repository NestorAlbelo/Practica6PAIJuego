...
public class EnemigoCueva implements InterfazPersonaje {
	...
	public void cambiarPoder(Personaje p) {
		p.setAtaque(PODER_ENEMIGO_CUEVA);		
	}

	@Override
	public void cambiarImagenes(Personaje p) throws IOException {
		Image Vivo = ImageIO.read(Ventana.class.getResourceAsStream("/Imagenes/EnemigoCuevaVivo.png"));
		Image Muerto = ImageIO.read(Ventana.class.getResourceAsStream("/Imagenes/EnemigoCuevaMuerto.png"));
